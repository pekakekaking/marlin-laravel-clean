...
class PictureInPostTest extends TestCase
{
    ...
    #[Test]
    public function can_store_or_update_picture_in_post(): void
    {
    ...
    #[Test]
    public function attribute_image_is_file(): void
    {
    ...
    #[Test]
    public function picture_can_be_updated_in_post_only_by_admin()
    {
