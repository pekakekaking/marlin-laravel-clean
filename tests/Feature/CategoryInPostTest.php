...
{
    #[Test] public function response_for_route_select_is_view_select_category()
    {
    ...
    #[Test] public function category_can_be_updated_in_post()
    {
        $user = \App\Models\User::find(4);
        $this->withoutExceptionHandling();
        $post = Post::find(1);
    ...
    #[Test] public function attribute_category_id_is_required()
    {
        $user = \App\Models\User::find(4);
        $post = Post::find(1);
        $data = [
    ...
    #[Test] public function category_can_be_updated_in_post_only_by_admin()
    {
