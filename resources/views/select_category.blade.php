...
<div class="max-w-2xl mx-auto">
    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <form action="/posts/{{$post['id']}}/category" method="POST">
                @csrf
                <div class="mb-4">
                    <div>
                        ...
                        <select id="category" name="category"
                            ...
                            <option @if($category['id']==$post['category']['id'])  selected @endif
                ...
                <button type="submit"
                        class="text-white inline-flex items-center bg-yellow-400 hover:bg-yellow-500 focus:outline-none focus:ring-4
                         focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 dark:focus:ring-yellow-900">
